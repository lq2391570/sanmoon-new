...
@interface DAViewController : UIViewController<UITextFieldDelegate,UITableViewDataSource,SMPopViewDelegate>
...
@property (nonatomic, retain) NSMutableArray * customers1;
