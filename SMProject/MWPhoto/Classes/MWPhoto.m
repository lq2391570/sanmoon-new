...
+ (MWPhoto *)photoWithURL:(NSURL *)url withName:(NSString *)name{
    return [[MWPhoto alloc] initWithURL:url withName:name];
    //return [[MWPhoto alloc] initWithURL:url]];
}
...
- (void)saveImage:(UIImage *)image
{
    ...
    [[EBookManage shardSingleton] saveImage:image withURL:[_photoURL absoluteString] withCoverName:_photoName];
    NSLog(@"%@",[_photoURL absoluteString]);
